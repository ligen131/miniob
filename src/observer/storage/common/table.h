...
public:
  ...
  RC insert_record(Trx *trx, int value_num, const Value *values,int data_num, const int *data_list_r);
...
private:
  ...
  RC make_record(int value_num, const Value *values, char * &record_out ,int data_l ,int data_r);
